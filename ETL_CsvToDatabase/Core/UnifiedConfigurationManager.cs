...
namespace ETL_CsvToDatabase.Core
{
    ...
    public class UnifiedConfigurationManager
    {
        ...
        {
            // For single-file published apps, use AppContext.BaseDirectory instead of Assembly.Location
            string assemblyDir = AppContext.BaseDirectory;
            
            // First check in the same directory as the executable
            string localConfig = Path.Combine(assemblyDir, "appsettings.json");
        ...
        /// <summary>
        /// Gets the full path for input CSV files directory
        /// </summary>
