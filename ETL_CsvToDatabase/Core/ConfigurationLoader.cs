    ...
    public static class ConfigurationLoader
    {
        ...
        private static AppConfig LoadUnifiedConfiguration()
        {
            ...
            return new AppConfig
            {
                ...
                {
                    CsvFolderPath = _unifiedConfig.GetInputCsvFilesPath(),
        ...
        public static void EnsureDirectoriesExist(ProcessConfig processConfig)
        {
            try
            {
                // CSV folder creation only - unified logging system handles log folders
                if (!Directory.Exists(processConfig.CsvFolderPath))
                {
                    Directory.CreateDirectory(processConfig.CsvFolderPath);
